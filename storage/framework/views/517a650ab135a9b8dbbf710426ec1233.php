...
<body>
    ...
    <div class="card login-card p-3">
        ...
        <div class="card-footer bg-white border-0 text-center pb-3">
            <small class="text-muted">Aplikasi Kasir v1.0 &copy; <?php echo e(date('Y')); ?></small>
        </div>
    </div>
...
</html><?php /**PATH C:\laragon\www\transaksi\resources\views/auth/login.blade.php ENDPATH**/ ?>